...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :weight bold :height 130))))
 '(org-level-2 ((t (:inherit outline-2 :weight bold :height 130))))
 '(org-level-3 ((t (:inherit outline-3 :weight bold :height 120))))
