...
(custom-set-variables
 ...
 '(package-selected-packages
   '(modus-themes emmet-mode js2-mode web-mode autothemer symon dmenu diminish company dashboard rainbow-delimiters sudo-edit hungry-delete evil switch-window avy undo-tree smex ido-vertical-mode beacon which-key use-package))
